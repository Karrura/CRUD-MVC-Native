...
<body>
<nav class="navbar navbar-expand-md navbar-dark fixed-top" style="background-color: #21325E; ">
  <div class="container-fluid">
    <span style="color: white; font-size: 25px"><b>Kadai</b></span>
    <span class="text-warning" style="font-size: 25px"><b>Lanjo</b></span>
